...
#Modified from wxPython.lib.mixins.rubberband
#to allow mouse events to be redirected from outside

#Original author 12/14/2003 - Jeff Grimmett (grimmtooth@softhome.net)

"""
Implements a 'rubberband' to select the zoomframe
"""
...
class RubberBand:
    ...
    def __init__(self, drawingSurface, aspectRatio=None):
        ...
        ### Disabled the binding to mouse events - Raja S ###
